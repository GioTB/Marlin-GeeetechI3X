...
#define STRING_CONFIG_H_AUTHOR "(GTB, Geeetech i3x)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Da'h Printehr"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 2560, 423.4 } // 423.4 -> E Steps calculados para BMG
